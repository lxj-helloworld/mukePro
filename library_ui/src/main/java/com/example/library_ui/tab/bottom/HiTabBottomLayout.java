...
import com.example.library_ui.tab.util.HiViewUtil;
...
public class HiTabBottomLayout extends FrameLayout implements IHiTabLayout<HiTabBottom, HiTabBottomInfo<?>> {
    ...
    @Override
    public void addTabSelectedChangeLisntener(OnTabSelectedListener<HiTabBottomInfo<?>> listener) {
    ...
    public void inflateInfo(@NonNull List<HiTabBottomInfo<?>> infoList) {
        ...
        // 移除之前已经添加的View on 2024/1/7 08:55
        for (int i = getChildCount() - 1; i > 0; i--) {
            removeViewAt(i);
        }
        selectedInfo = null;
        addBackground();
        // 移除监听器 on 2024/1/7 09:06
        ...
        // 将每一个item添加进FrameLayout on 2024/1/7 09:10
        for (int i = 0; i < infoList.size(); i++) {
            Log.i("TAG", "inflateInfo: i = " + i);
    ...
    **/
    ...
    private void addBackground() {
        ...
        params.gravity = Gravity.BOTTOM;
        // 添加背景View on 2024/1/7 09:02
        addView(view, params);
        // 设置透明度 on 2024/1/7 09:02
