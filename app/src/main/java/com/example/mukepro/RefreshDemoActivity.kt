...
import com.example.library_ui.refresh.HiRefresh
import com.example.library_ui.refresh.HiRefreshLayout
import com.example.library_ui.refresh.HiTextOverView
...
class RefreshDemoActivity : AppCompatActivity() {
    ...
    var myDataset =
        arrayOf(
            "HiRefresh", "HiRefresh", "HiRefresh", "HiRefresh", "HiRefresh", "HiRefresh",
            "HiRefresh", "HiRefresh", "HiRefresh", "HiRefresh", "HiRefresh", "HiRefresh",
            "HiRefresh", "HiRefresh", "HiRefresh", "HiRefresh", "HiRefresh", "HiRefresh"
        )
